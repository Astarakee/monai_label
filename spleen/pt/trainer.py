...
def save_checkpoint(metric, model, best_metric, epoch, abs_path_checkpoint, abs_path_checkpoint_ts, best_metric_epoch):
...
def training(max_epochs, model, train_loader, optimizer, loss_function,
    ...
    for epoch in range(max_epochs):
        ...
        if (epoch + 1) % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                best_metric_epoch = save_checkpoint(metric, model, best_metric, epoch, abs_path_checkpoint, abs_path_checkpoint_ts, best_metric_epoch)
